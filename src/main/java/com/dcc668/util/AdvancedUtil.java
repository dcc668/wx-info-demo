...
import com.dcc668.message.resp.Music;
import com.dcc668.pojo.*;
...
public class AdvancedUtil {
	...
	public static void main(String args[]) {
		 ...
		 * 获取用户信息
		 */
		WeixinUserInfo user = getUserInfo(accessToken, "oEoyzwty6rUHaC8PE9qZqDoUJ-Fs");
		 ...
		 */
		// 组装文本客服消息
		String jsonTextMsg = makeTextCustomMessage("oEoyzwty6rUHaC8PE9qZqDoUJ-Fs", "点击查看<a href=\"http://wangxin123.com\">王鑫的博客</a>");
		// 发送客服消息
		...
		list.add(article2);
		// 组装图文客服消息
		String jsonNewsMsg = makeNewsCustomMessage("oEoyzwty6rUHaC8PE9qZqDoUJ-Fs", list);
		// 发送客服消息
		 ...
		 * 移动用户分组
		 */
		updateMemberGroup(accessToken, "oEoyzwty6rUHaC8PE9qZqDoUJ-Fs", 100);
